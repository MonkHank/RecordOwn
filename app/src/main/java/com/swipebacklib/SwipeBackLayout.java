...
public class SwipeBackLayout extends FrameLayout {
     ...
     * 无效的指向
     */
    public static final int INVALID_POINTER=ViewDragHelper.INVALID_POINTER;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // TODO: 2019-05-27  StyleableRes   AttrRes    StyleRes
    ...
    /**
     * Register a cameraCallback to be invoked when a swipe event is sent to this
     * view.
     *
    ...
    /**
     * Add a cameraCallback to be invoked when a swipe event is sent to this view.
     *
     * @param listener the swipe listener to attach to this view
     */
