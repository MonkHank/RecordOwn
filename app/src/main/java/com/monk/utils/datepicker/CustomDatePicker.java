...
public final class CustomDatePicker {
    ...
    private DatePickerView dpvYear, dpvMonth, dpvDay, dpvHour, dpvMinutes;
    ...
    private TextView tvCancel, tvSelect, tvHour, tvMinutes, tvYear, tvMonth, tvDay;

    private boolean isSpecificMinutes;
    ...
    private void addListener() {
        ...
        dpvMinutes.setOnSelectListener(new DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
    ...
    private void executeScroll() {
        ...
        dpvMinutes.setCanScroll(minute.size() > 1 && (scrollUnits & SCROLL_TYPE.MINUTE.value) == SCROLL_TYPE.MINUTE.value);
    }
    ...
    public void showSpecificTime(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
                dpvHour.setVisibility(View.VISIBLE);//日 后面的数字（时）
                tvHour.setVisibility(View.VISIBLE);// 时
                dpvMinutes.setVisibility(View.VISIBLE);//分钟数字
                tvMinutes.setVisibility(View.VISIBLE);//分
            } else {
                disScrollUnit(SCROLL_TYPE.HOUR, SCROLL_TYPE.MINUTE);
                dpvHour.setVisibility(View.GONE);
                tvHour.setVisibility(View.GONE);
                dpvMinutes.setVisibility(View.GONE);
    ...
    public void showSpecificDate(boolean show) {
        if (canAccess) {
            if (show) {
                dpvYear.setVisibility(View.VISIBLE);
                tvYear.setVisibility(View.VISIBLE);
                dpvMonth.setVisibility(View.VISIBLE);
                tvMonth.setVisibility(View.VISIBLE);
                dpvDay.setVisibility(View.VISIBLE);
                tvDay.setVisibility(View.VISIBLE);
            } else {
                dpvYear.setVisibility(View.GONE);
                tvYear.setVisibility(View.GONE);
                dpvMonth.setVisibility(View.GONE);
                tvMonth.setVisibility(View.GONE);
                dpvDay.setVisibility(View.GONE);
    ...
    public void setIsLoop(boolean isLoop) {
        if (canAccess) {
            ...
            this.dpvMinutes.setIsLoop(isLoop);
        }
    }
    ...
    public void setIsSpecificMinutes(boolean isSpecificMinutes) {
