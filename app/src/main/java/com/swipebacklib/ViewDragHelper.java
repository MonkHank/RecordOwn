 ...
 * et2 of useful operations and state tracking for allowing a user to drag
...
public class ViewDragHelper {
     ...
     * view upon request. The cameraCallback also makes decisions governing the range
    ...
    public static abstract class Callback {
         ...
         * cameraCallback should return true if the user is permitted to drag the
...
//        mScroller = ScrollerCompat.create(context, sInterpolator);
     ...
     * cameraCallback will be notified but
    ...
    /**
     * Like all cameraCallback events this must happen on the UI thread, but release
    ...
    /**
     * Attempt to capture the view with the given pointer ID. The cameraCallback will
     ...
     * true without consulting the cameraCallback.
     *
     ...
     * dispatch cameraCallback events as needed before returning. The parent view's
    ...
    public void setTouchedFullScreen(boolean touchFlag,int flag) {
